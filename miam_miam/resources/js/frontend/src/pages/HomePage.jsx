...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-muted">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-secondary via-secondary to-primary/20 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-balance">Bienvenue chez Mon Miam Miam</h1>
            <p className="text-xl md:text-2xl mb-8 text-balance text-white/90">
              Votre restaurant universitaire préféré. Commandez en ligne et gagnez des points de fidélité !
            </p>
            <Link
              to="/register"
              className="inline-flex items-center gap-2 bg-primary text-secondary px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-dark transition-colors"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {promotionItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-muted rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {mockTopCustomers.map((customer, index) => (
              <div key={customer.id} className="bg-muted rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
